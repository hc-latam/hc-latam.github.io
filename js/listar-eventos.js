...
function crearTarjetaEvento(id, nombre, logo, fecha, artefacto, anillo, amuleto, joyeria, armaduras, armas, extras, outfit, tipo) {
    ...
    if (anillo) contenido += "<li class='list-group-item bg-dark p-0 border-0 joyeria'><a href='#' data-toggle='modal' data-target='#anilloModal' data-evento='"+id+"'><img src='img/eventos/anillos/" + anillo + "' alt='" + anillo + "' class='img-fluid mb-3'></a> ";
    if (amuleto) contenido += " <a href='#' data-toggle='modal' data-target='#amuletoModal' data-evento='"+id+"'><img src='img/eventos/amuletos/" + amuleto + "' alt='" + amuleto + "' class='img-fluid mb-3'></a></li>";
